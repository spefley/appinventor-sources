 ...
 */
public class JSEditorPanel extends HTMLPanel {
  ...
  public interface BlocklyWorkspaceChangeListener {
     ...
     *
     * @param panel Source JSEditorPanel where the event occurred.
     * @param event Native object representing the event.
     */
    void onWorkspaceChange(JSEditorPanel panel, JavaScriptObject event);
  }
  ...
  public JSEditorPanel(String formName, BlocksCodeGenerationTarget targetPlatform) {
  ...
  public JSEditorPanel(String formName, BlocksCodeGenerationTarget targetPlatform,
    ...
    OdeLog.log("Created JSEditorPanel for " + formName);
  }
  ...
  private static native void exportMethodsToJavascript() /*-{
    $wnd.JSEditorPanel_checkIsAdmin =
        $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::checkIsAdmin());
    $wnd.JSEditorPanel_indicateDisconnect =
        $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::indicateDisconnect());
    // Note: above lines are longer than 100 chars but I'm not sure whether they can be split
    $wnd.JSEditorPanel_pushScreen =
        $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::pushScreen(Ljava/lang/String;));
    $wnd.JSEditorPanel_popScreen =
        $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::popScreen());
    $wnd.JSEditorPanel_createDialog =
        $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::createDialog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILcom/google/gwt/core/client/JavaScriptObject;));
    $wnd.JSEditorPanel_hideDialog =
        $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::HideDialog(Lcom/google/gwt/user/client/ui/DialogBox;));
    $wnd.JSEditorPanel_setDialogContent =
        $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::SetDialogContent(Lcom/google/gwt/user/client/ui/DialogBox;Ljava/lang/String;));
    $wnd.JSEditorPanel_storeBackpack =
      $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::storeBackpack(Ljava/lang/String;));
    $wnd.JSEditorPanel_getOdeMessage =
      $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::getOdeMessage(Ljava/lang/String;));
    $wnd.JSEditorPanel_setGridEnabled =
      $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::setGridEnabled(Z));
    $wnd.JSEditorPanel_setSnapEnabled =
      $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::setSnapEnabled(Z));
    $wnd.JSEditorPanel_getGridEnabled =
      $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::getGridEnabled());
    $wnd.JSEditorPanel_getSnapEnabled =
      $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::getSnapEnabled());
    $wnd.JSEditorPanel_saveUserSettings =
      $entry(@com.google.appinventor.client.editor.blocks.JSEditorPanel::saveUserSettings());
  }-*/;
  ...
  private native void initWorkspace(String projectId, boolean readOnly, boolean rtl, String targetLang)/*-{
    ...
    var workspace = Blockly.BlocklyEditor.create(el,
      this.@com.google.appinventor.client.editor.blocks.JSEditorPanel::formName,
      readOnly, rtl, targetLang);
    workspace.projectId = projectId;
    var cb = $entry(this.@com.google.appinventor.client.editor.blocks.JSEditorPanel::workspaceChanged(Lcom/google/gwt/core/client/JavaScriptObject;));
    cb = cb.bind(this);
    ...
    this.@com.google.appinventor.client.editor.blocks.JSEditorPanel::workspace = workspace;
  }-*/;
  ...
  native void injectWorkspace()/*-{
    var el = this.@com.google.gwt.user.client.ui.UIObject::getElement()();
    Blockly.ai_inject(el, this.@com.google.appinventor.client.editor.blocks.JSEditorPanel::workspace);
  }-*/;

  /**
   * Make the workspace associated with the JSEditorPanel the main workspace.
   */
  native void makeActive()/*-{
    Blockly.mainWorkspace = this.@com.google.appinventor.client.editor.blocks.JSEditorPanel::workspace;
  ...
  public native void doLoadBlocksContent(String formJson, String blocksContent) /*-{
    var workspace = this.@com.google.appinventor.client.editor.blocks.JSEditorPanel::workspace;
  ...
  public native String getBlocksContent() /*-{
    return this.@com.google.appinventor.client.editor.blocks.JSEditorPanel::workspace
      .saveBlocksFile();
  }-*/;
  ...
  public native void addComponent(String uid, String instanceName, String typeName)/*-{
    this.@com.google.appinventor.client.editor.blocks.JSEditorPanel::workspace
  ...
  public native void populateComponentTypes(String jsonComponentsStr) /*-{
    this.@com.google.appinventor.client.editor.blocks.JSEditorPanel::workspace
      .populateComponentTypes(jsonComponentsStr, @com.google.appinventor.client.editor.blocks.JSEditorPanel::SIMPLE_COMPONENT_TRANSLATIONS);
  }-*/;
