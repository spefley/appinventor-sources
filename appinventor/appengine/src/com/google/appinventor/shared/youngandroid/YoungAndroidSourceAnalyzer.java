...
public class YoungAndroidSourceAnalyzer {
  ...
  public static final String IOT_SRC_FOLDER = "sketches";
   ...
   * by the IOT editors.
   */
  public static final String MICROCONTROLLER_PROPERTIES_EXTENSION = ".json";

  /**
   * The filename extension for the file that contains data
   */
  public static final String IOTVM_BLOCKS_EXTENSION = ".xml";
